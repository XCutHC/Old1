...
ind = strArr.index("E")
while ind != nil
arr_2 = strArr[0..(ind - 1)].sort
ind_2 = strArr.index("#{arr_2[0]}")
arr << arr_2[0]
strArr.delete_at(ind)
strArr.delete_at(ind_2)
ind = strArr.index("E")
end
puts arr.join(",")
end
...
# parameter being passed which will be an array of integers ranging from 1...n
