...
arr2 = []
arr3 = []
if strArr[0].size > strArr[1].size
    strArr = strArr.shuffle
  else
    strArr = strArr
end
...
size2 = arr2.size
  (0..size1 - 1).each do |e|
    ...
    puts (arr3 + arr2[size1..size2]).join("-")
    end
end
ArrayMatching("[1, 2, 5, 1]", "[5, 2, 8, 11, 5]")
...
# two integer arrays, and your goal for this challenge is to add the elements in
